  ...
  return (
    ...
    >
      <div className="flex flex-row items-center justify-start gap-2 font-[Poppins]  p-2">
        <button className="border-[1.5px] border-black p-1 rounded-sm">
        ...
        <div className="flex flex-row items-center justify-between gap-1 border-[1.5px] border-black px-2 rounded-sm">
          <input
            placeholder="Search"
